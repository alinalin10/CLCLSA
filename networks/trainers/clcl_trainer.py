...
from networks.models.clcl import CLUECL3_2, CLUECL3_3, Classifier, EV_SV, SingleViewData
...
class CLCLSA_Trainer_3(object):

    def __init__(self, params):
        self.params = params
        self.device = self.params['device']
        self.__init_dataset__()
        self.model = CLUECL3_3(self.dim_list, self.params['hidden_dim'], self.num_class, self.params['dropout'], self.params['prediction'])
        # print(self.dim_list)
